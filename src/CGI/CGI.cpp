...
/*   Updated: 2022/06/30 15:27:03 by lde-la-h      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static std::vector<std::string> get_envp(const ft::Request& request, const std::string& path) 
{
	...
	std::vector<std::string> envp = {
		...
		ft::format("REMOTE_ADDR=%d", -1), // TODO: Where ????
		...
		// Do we need this ?
		ft::format("CONTENT_LENGTH=%s", "TODO: Fill in!"), // TODO: this is the length of the BODY in the REQUEST (NOT the response)
	};
